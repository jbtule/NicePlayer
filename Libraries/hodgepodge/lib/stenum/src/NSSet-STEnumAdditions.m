...
#import "NSSet-STEnumAdditions.h"

@interface  NSSet(STPrivateAdditions)
...
@implementation NSSet(STPrivateAdditions)
...
-(id)_STEmptyMutableCollection{
    return [NSMutableSet setWithCapacity:[self count]]; 
}
...
-(id)_STReturnMeFromCollection:(id)aCollection{
    return [[self classForCoder] setWithSet:aCollection];
}
@end

@implementation NSSet(STSharedCollectionAdditions)
