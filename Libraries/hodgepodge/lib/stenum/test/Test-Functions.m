...
id Test_ST_convertToNumbers(id obj, void * context){
    return [NSNumber numberWithInt:[obj intValue]];
}

BOOL Test_ST_selectNegativeNumbers(id obj, void * context){
    return [obj intValue] < 0;
}

id Test_ST_concatElements(id obj,id concat, void * context){
    return [concat stringByAppendingString:obj];
}

id Test_ST_sumElements(id obj,id sum, void * context){
